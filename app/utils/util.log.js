 ...
 */
utilLog.capsule = function(title, info, type = 'primary') {
    console.log(
        `%c ${title} %c ${info} %c`,
 ...
 * @description 打印彩色文字
 */
utilLog.colorful = function(textArr) {
    console.log(
